											...
											<TBODY>
												<TR>
													...
													<TD><INPUT class=regtxt title=请填写用户名 maxLength=16
														size=16 value="" name=username></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>密&nbsp;
															码：</FONT></TD>
													<TD><INPUT class=regtxt title=请填写密码 type=password
														maxLength=16 size=16 value="" name=password></TD>
												</TR>
												<TR>
													<TD align=middle width=81><FONT color=#ffffff>身&nbsp;
															份：</FONT></TD>
												...
												<td>
												<% 
												if(request.getSession().getAttribute("sure")==null){
					 								out.println("");
												}
												else if(request.getSession().getAttribute("sure").toString().equals("false")){
													response.setContentType("text/html;charset=utf-8");
													out.println("密码或用户名错<br>误请重新输入"); 
													request.getSession().setAttribute("sure",null);
												}
												%>
												</td>
												<td>
												...
												<a href="regist.jsp" class="btn btn-primary btn-lg disabled" role="button"><font color="yellow">还没有账号？？快来注册吧</font></a>
												</td>
												</tr>
											</TBODY>
										</TABLE>
